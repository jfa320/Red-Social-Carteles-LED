package com.example.redsocialcartelesled;
 ...
 */
public class RedsocialcartelesledTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/RedSocialCartelesLED");
    }
